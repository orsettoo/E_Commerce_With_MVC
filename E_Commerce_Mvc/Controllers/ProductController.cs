...
namespace E_Commerce_Mvc.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        public ProductController(IProductService productService,IFeatureService featureService, ICategoryService categoryService,IWebHostEnvironment webHostEnvironment, IProductImageService productImageService, E_Commerce_MvcContext context)
        {
        ...
        public async Task<IActionResult> CreateFeatures(FeatureListModel model, [FromRoute]int productId)
        {
            ...
            for (var i = 0; i <= model.FeatureName.Length-1; i++)
            {
                ...
                featureDTO.FeatureName = model.FeatureName[i];
                featureDTO.ProductId = productId;
